...
declare var $: any;
@Component({
    selector: "app-macquarie-manual-match",
    styleUrls: ["./macquarie-manual-match.component.css"],
    templateUrl: "./macquarie-manual-match.component.html",
})
export class MacquarieManualMatchComponent extends DataFeedsBaseComponent implements OnInit {
