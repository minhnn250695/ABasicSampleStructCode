...
@Component({
  selector: 'app-hub24-match',
  templateUrl: './hub24-match-records.component.html',
  styleUrls: ['./hub24-match-records.component.css']
})
export class Hub24MatchComponent extends DataFeedsBaseComponent implements OnInit {
  ...
  btnImportClick() {
    ...
    if (list && list.length > 0) {
      ...
      this.dataFeedsService.importClientAssetToCRM("Hub24", list).subscribe((res) => {
