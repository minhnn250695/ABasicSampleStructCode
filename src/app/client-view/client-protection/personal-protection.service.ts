...
import {
  BaseResponse, InsuranceInfo,
  InsuranceObjective, PersonalInsuranceOutcomes, PersonalInsuranceSummary, TotalInsuranceInfo,
  TotalInsuranceObjective, TotalPersonalInsurance, TotalPersonalInsuranceSummary, UserDoc
} from './models';

@Injectable()
export class PersonalProtectionService {
  // insurance summary
