...
export class MemberCardComponent extends BaseComponentComponent implements OnInit, OnDestroy {
   ...
   * VIEW DATA BINDING
   */
  private lifeInsuranceTotal() {
    return this.personalInsuranceOutcomes && this.personalInsuranceOutcomes.lifeInsuranceTotal || 0;
  }

  private incomeProtectionTotal() {
    return this.personalInsuranceOutcomes && this.personalInsuranceOutcomes.incomeProtectionTotal || 0;
  }

  private tpdInsuranceTotal() {
    return this.personalInsuranceOutcomes && this.personalInsuranceOutcomes.tpdInsuranceTotal || 0;
  }

  private traumaInsuranceTotal() {
    return this.personalInsuranceOutcomes && this.personalInsuranceOutcomes.traumaInsuranceTotal || 0;
  }
}
